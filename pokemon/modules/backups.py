...
import pokemon.modules.sql.notes_sql as sql
from pokemon import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, MESSAGE_DUMP
from pokemon.__main__ import DATA_IMPORT
from pokemon.modules.helper_funcs.chat_status import user_admin
from pokemon.modules.helper_funcs.misc import build_keyboard, revert_buttons
from pokemon.modules.helper_funcs.msg_types import get_note_type
from pokemon.modules.rules import get_rules
import pokemon.modules.sql.rules_sql as rulessql
from pokemon.modules.sql import warns_sql as warnssql
import pokemon.modules.sql.blacklist_sql as blacklistsql
from pokemon.modules.sql import disable_sql as disabledsql
from pokemon.modules.sql import cust_filters_sql as filtersql
import pokemon.modules.sql.welcome_sql as welcsql
import pokemon.modules.sql.locks_sql as locksql
...
def export_data(bot: Bot, update: Update, chat_data):
    ...
    f=open("pokemon{}.backup".format(chat_id), "w")
    ...
    try:
        ...
        pass
    bot.sendDocument(current_chat_id, document=open('pokemon{}.backup'.format(chat_id), 'rb'), caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This  is specially made for notes.".format(chat.title, chat_id, tgl), timeout=360, reply_to_message_id=msg.message_id, parse_mode=ParseMode.MARKDOWN)
    os.remove("pokemon{}.backup".format(chat_id)) # Cleaning file
