...
from pokemon import dispatcher, DEV_USERS, VERSION
...
import pokemon.modules.helper_funcs.git_api as git
...
def speedtestxyz_callback(bot: Bot, update: Update):
    ...
    if query.from_user.id in DEV_USERS:
        ...
        query.answer("You are required to join Bot Lab | Red Support to use this command.")
