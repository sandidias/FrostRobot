...
Can be found on telegram as [Pokemon](https://t.me/).

The Support group can be reached out to at [Bot Lab|Ash Support](https://t.me/BotLabSupport), where you can ask for help about [Pokemon](https://t.me/As), discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
